...
# Enhanced NFC
# $(call inherit-product, vendor/kos/config/nfc_enhanced.mk)

# Inherit some common KOS stuff.
$(call inherit-product, vendor/kos/config/common_full_phone.mk)

PRODUCT_NAME := kos_bacon
